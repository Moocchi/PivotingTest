...
<head>
    ...
    <title>Invoice - Gudang - {{ $record->kode_barang ?? 'Kode Barang Tidak Ditemukan' }}</title>
...
<body>
    <div class="invoice-box">
        <table>
            ...
            <tr class="item">
                <td>{{ $record->kode_barang ?? 'N/A' }}</td>

                <td>{{ $record->nama_barang ?? 'N/A' }}</td>

                <td>{{ $record->jenis_barang ?? 'N/A' }}</td>

                <td>{{ $record->stok ?? 'N/A' }}</td>

                <td>{{ $record->satuan ?? 'N/A' }}</td>
            </tr>
        </table>
    </div>
</body>
