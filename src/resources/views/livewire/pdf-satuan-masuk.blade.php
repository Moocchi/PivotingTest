...
<head>
    ...
    <title>Invoice - Barang Masuk - {{ $kode_barang ?? 'Kode Barang Tidak Ditemukan' }}</title>
...
<body>
    <div class="invoice-box">
        <table>
            ...
            <tr class="item">
                <td>{{ $kode_barang ?? 'N/A' }}</td>

                <td>{{ $nama_barang?? 'N/A' }}</td>

                <td>{{ $jenis_barang ?? 'N/A' }}</td>

                <td>{{ $record->tanggal_masuk ?? 'N/A' }}</td>

                <td>{{ $record->jumlah_masuk ?? 'N/A' }}</td>
            </tr>
        </table>
    </div>
</body>
